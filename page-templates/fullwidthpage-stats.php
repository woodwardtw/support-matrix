		...
		<div class="row">
			...
			<div class="col-md-12 content-area" id="primary">
				...
				<?php 
					...
					endwhile;
					echo '<tr><td>Average</td><td>' . average_score($avg_1) . '</td><td>' . average_score($avg_2) . '</td><td>' . average_score($avg_3). '</td><td>' . average_score($avg_4) . '</td><td>' . average_score($avg_5) . '</td><td>' . average_score($avg_6) . '</td><td>' . average_score($avg_7) . '</td><td>' . average_score($avg_8) . '</td><td>' . average_score($avg_9) . '</td><td>' . average_score($avg_10) . '</td></tr>';
					echo '<tr><td>Number of 1s</td><td>' . count_of_score(1,$avg_1) . '</td><td>' . count_of_score(1,$avg_2) . '</td><td>' . count_of_score(1,$avg_3). '</td><td>' . count_of_score(1,$avg_4) . '</td><td>' . count_of_score(1,$avg_5) . '</td><td>' . count_of_score(1,$avg_6) . '</td><td>' . count_of_score(1,$avg_7) . '</td><td>' . count_of_score(1,$avg_8) . '</td><td>' . count_of_score(1,$avg_9) . '</td><td>' . count_of_score(1,$avg_10) . '</td></tr>';
					echo '<tr><td>Number of 2s</td><td>' . count_of_score(2,$avg_1) . '</td><td>' . count_of_score(2,$avg_2) . '</td><td>' . count_of_score(2,$avg_3). '</td><td>' . count_of_score(2,$avg_4) . '</td><td>' . count_of_score(2,$avg_5) . '</td><td>' . count_of_score(2,$avg_6) . '</td><td>' . count_of_score(2,$avg_7) . '</td><td>' . count_of_score(2,$avg_8) . '</td><td>' . count_of_score(2,$avg_9) . '</td><td>' . count_of_score(2,$avg_10) . '</td></tr>';
					echo '<tr><td>Number of 3s</td><td>' . count_of_score(3,$avg_1) . '</td><td>' . count_of_score(3,$avg_2) . '</td><td>' . count_of_score(3,$avg_3). '</td><td>' . count_of_score(3,$avg_4) . '</td><td>' . count_of_score(3,$avg_5) . '</td><td>' . count_of_score(3,$avg_6) . '</td><td>' . count_of_score(3,$avg_7) . '</td><td>' . count_of_score(3,$avg_8) . '</td><td>' . count_of_score(3,$avg_9) . '</td><td>' . count_of_score(3,$avg_10) . '</td></tr>';
					echo '</tbody></table>';
					endif;
